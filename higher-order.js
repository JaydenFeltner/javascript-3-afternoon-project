...
//Code Here
let myStrongest = monstersInYourPocket.filter( cp => cp.CP > 200 ) // = monstersInYourPocket.filter(/* Provide Your Callback Here */)
...
let orderTotals = orders.map( taxes => taxes.price + (taxes.price * taxes.tax) )
